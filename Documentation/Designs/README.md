...
構成と書き方、および設計書を起点とした実装フロー（設計書 → Codex による実装 → 確認 → バージョン更新 → コミット）は [`.claude/skills/implement/SKILL.md`](../../.claude/skills/implement/SKILL.md) にあります。Claude Code からは `/implement` で呼び出せます。
